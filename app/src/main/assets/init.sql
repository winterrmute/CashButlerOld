...
CREATE TABLE IF NOT EXISTS ProposedCategoriesAndAccounts (
    id INTEGER NOT NULL PRIMARY KEY,
    rootCategory TEXT NOT NULL,
    data TEXT NOT NULL
);

INSERT INTO ProposedCategoriesAndAccounts (rootCategory, data) VALUES ("Cash Flow", '[{"category":"Cash","accounts":[]},{"category":"Bank accounts","accounts":[]},{"category":"Digital wallets","accounts":[{"title":"PayPal"},{"title":"Venmo"},{"title":"Cash App"},{"title":"Revolut"}]},{"category":"Credit Cards","accounts":[{"title":"Visa"},{"title":"MasterCard"},{"title":"American Express"},{"title":"Braintree"}]},{"category":"Cryptocurrency","accounts":[{"title":"Coinbase"},{"title":"Blockchain.info"},{"title":"Electrum"},{"title":"Trezor"},{"title":"Ledger Live"}]}]');
