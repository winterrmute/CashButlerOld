...
import com.wintermute.mobile.cashbutler.data.persistence.converter.ProposedCategoriesAndAccountsConverter
...
@Database(
    entities = [
        ...
        Saving::class,
        Transaction::class,
        ProposedCategoriesAndAccounts::class
    ],
    version = 1,
    exportSchema = false
)
@TypeConverters(BigDecimalConverter::class, ProposedCategoriesAndAccountsConverter::class)
abstract class AppDatabase : RoomDatabase() {

    abstract fun proposedCategoriesAndAccountsDao(): ProposedCategoriesAndAccountsDao
